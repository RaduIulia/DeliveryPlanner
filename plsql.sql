...
lista_iteme nume_array := nume_array('Nori', 'Carrot', 'Figs', 'Jalfrezi Mix', 'Salmon', 'Bay Leaves', 'Lettuce', 'Sultanas', 'Mulled Wine Spices', 'Firefly squid', 'Feta', 'Eggplant', 'Dried Apricots', 'Cardamom Whole', 'Mackerel', 'Vinegar', 'Parsnip', 'Blueberries', 'Fenugreek Leaf', 'Bloody clam', 'Corn Tortilla', 'Beetroot', 'Dried Apricots', 'Cajun Seasoning', 'Mirugai clam', 'Walnut', 'Asian Greens', 'Cantaloupe', 'Mixed Spice', 'Alaskan pink shrimp', 'Mussels', 'Carob Carrot', 'Guava', 'Oregano', 'Orient clam', 'Flaxseed Oil', 'French eschallots', 'Grapefruit', 'Fish Seasoning', 'Oyster', 'Turkey', 'Iceberg lettuce', 'Pomegranate', 'Thai Creen Curry Mix', 'Halfbeak', 'Ricemilk', 'Bread', 'Figs', 'Tikka Masala', 'Japanese horse mackerel', 'Broccolini', 'Asian Greens', 'Blueberries', 'Jerk Seasoning', 'Mirugai clam', 'Snowpea sprouts', 'Zucchini', 'Mango', 'Orange Zest', 'White trevally', 'Silverbeet', 'English Spinach', 'Pomegranate', 'Colombo Powder', 'Greater amberjack', 'Iceberg Lettuce', 'Fresh Chillies', 'Peaches', 'Sweet Basil', 'Milt', 'Flour', 'Tea', 'Lychees', 'Garlic Chips', 'Japanese style-chunky omelette', 'Cornmeal', 'Beans', 'Blood oranges', 'Pickling Spice', 'Salmon', 'Licorice', 'Celery', 'Sultanas', 'Celery Leaf', 'Abalone', 'Liver', 'Bean Shoots', 'Goji Berry', 'Achiote Seed', 'Oyster', 'Gruyere', 'Capers', 'Currants', 'Sesame Seed', 'Small amberjack', 'Bush Tomato', 'Okra', 'Nectarines', 'Spice Charts', 'Japanese sea bass', 'Avocado', 'Zucchini', 'Sprouts', 'Lime Leaves Ground', 'Japanese style-chunky omelette', 'Wholegrain Bread', 'Cabbage', 'Passionfruit', 'Chilli Pepper', 'Fanta', 'Polenta', 'Sweet Potato', 'Bush Tomato', 'Paprika Smoked', 'Crab', 'Papaw', 'Rhubarb', 'Mulberries', 'Colombo Powder', 'Bloody clam', 'Pine Nut', 'Kale', 'Mangosteens', 'Turmeric', 'Trough shells', 'Cottage Cheese', 'Capers', 'Bush Tomato', 'Peppercorns Black', 'Amberjack', 'Borlotti Beans', 'Twix', 'Bush Tomato', 'Cinnamon Sticks', 'Abalone', 'Green Tea', 'Artichoke', 'Prunes', 'Methi Leaves', 'Whitespotted conger', 'Blue Swimmer Crab', 'Onion', 'Berries', 'Cloves Whole', 'Japanese horse mackerel', 'Celery Seed', 'Monster', 'Water', 'Pot Marjoram', 'Mirinda', 'Green Pepper', 'Pumpkin', 'Cavalo', 'Sesame Seed', 'Scallop', 'Duck', 'Chives', 'Peaches', 'Piri Piri Seasoning', 'Rosy seabass', 'Tabasco', 'Bean Shoots', 'Dried Apricots', 'Mango Powder', 'Milt', 'Tea Oil', 'Red cabbage', 'Currants', 'Cumin Seed', 'Skipjack tuna', 'Cumin', 'Cauliflower', 'Cherries', 'Lemon Pepper', 'Bloody clam', 'Kokam', 'Brussels Sprouts', 'Jarrahdale pumpkin', 'Cinnamon Ground', 'Biscuits', 'Figs', 'Chinese Cabbage', 'Sprouts', 'Salt', 'Japanese spanish mackerel', 'Garlic', 'Radish', 'Cherries', 'Peppercorns Cracked Black', 'Bastard halibut', 'Oysters', 'Purple carrot', 'Corella Pear', 'Lemon Grass', 'Japanese spanish mackerel', 'Passionfruit', 'Cabbage', 'Jarrahdale pumpkin', 'Coriander Seed', 'Amberjack', 'Vermicelli Noodles', 'Redbull', 'Peaches', 'Mexican Salsa Mix', 'Tedi', 'Cottage Cheese', 'Dried Chinese Broccoli', 'Cumquat', 'Pimento Ground', 'Japanese style-chunky omelette', 'Gruyere', 'Snowpea sprouts', 'Lemon', 'Curly Leaf Parsley', 'Hell', 'Kumera', 'Radish', 'Grapes', 'Pepper Black Ground', 'Horned turban', 'Dried Apricots', 'Cos lettuce', 'Nectarines', 'Celery Seed', 'Timbark', 'Starfruit', 'Chives', 'Incaberries', 'Cloves Whole', 'Bastard halibut', 'Beef Stock', 'Beans', 'Custard Apples', 'Garlic Powder', 'Japanese style-chunky omelette', 'Curry Leaves', 'Lemon', 'Starfruit', 'Lemon Pepper', 'Small amberjack', 'Cayenne', 'Rhubarb', 'Mulberries', 'Mulled Cider Spices', 'Bastard halibut', 'Pine Nut', 'Chilli Pepper', 'Tangelo', 'Mustard Seed White', 'Horned turban', 'Balsamic Vinegar', 'Cornichons', 'Lemon', 'Parsley Flat Leaf', 'Octopus', 'Brown Rice Vinegar', 'Broccolini', 'Butternut pumpkin', 'Cumin Ground', 'Mackerel', 'Mustard Seed', 'Bok Choy', 'Lemon', 'Peppercorns White', 'Bastard halibut', 'Blue Swimmer Crab', 'Potatoes', 'Loquats', 'Cumin Seed Royal', 'Whitespotted conger', 'Sprouts', 'Jicama', 'Figs', 'Parsley', 'Amberjack', 'Lemon', 'Lettuce', 'Longan', 'Fennel Seed', 'Rosy seabass', 'Cream Cheese', 'Red Pepper', 'Melon', 'Chamomile', 'Sea bream', 'Besan', 'Dried Chinese Broccoli', 'Blackberries', 'Thai Creen Curry Mix', 'Mirugai clam', 'Beef Stock', 'Leeks', 'Passionfruit', 'Rice Paper', 'Japanese whiting', 'Liver', 'Carrot', 'Apricots', 'Rosemary', 'Timisoreana', 'Corn Syrup', 'Sun dried tomatoes', 'Mangosteens', 'Garam Masala', 'Rosy seabass', 'Dried Apricots', 'Peppers', 'Sultanas', 'Asafoetida', 'Trough shells', 'Kenchur', 'Butternut lettuce', 'Pineapple', 'Cinnamon Powder', 'Japanese spanish mackerel', 'Butter Beans', 'Zucchini', 'Tangelo', 'Chocolate', 'Halfbeak', 'Almond Oil', 'Peas', 'Figs', 'Chamomile', 'Bloody clam', 'Soy Milk', 'Squash', 'Butternut pumpkin', 'Mace Whole', 'Mackerel', 'Cucumber', 'Proxi', 'Apple', 'Liquorice Root', 'Greater amberjack', 'Fish Sauce', 'Cos lettuce', 'Banana', 'Parsley', 'Abalone', 'Peppermint', 'Cabbage', 'Tomatoes', 'Chilli Crushed', 'Dotted gizzard shad', 'Mulberries', 'Potatoes', 'Olives', 'Pepsi', 'Alaskan pink shrimp', 'Cashews', 'Fresh Chillies', 'Apricots', 'Fajita Seasoning', 'Tuna', 'Kale', 'Potatoes', 'Nectarines', 'Mulled Wine Spices', 'Botan shrimp', 'Green Beans', 'Beer', 'Grapefruit', 'Thai Creen Curry Mix', 'Japanese sea bass', 'Fresh Chillies', 'Spinach', 'Goji Berry', 'Rose Baie', 'Firefly squid', 'Banana', 'Carrot', 'Cavalo', 'Mustard Seed White', 'Japanese sea bass', 'French Eschallots', 'Beans', 'Feijoa', 'Lemon Pepper', 'Trout', 'Radish', 'Lion', 'Fingerlime', 'Oregano', 'Salmon', 'Cous Cous', 'Garlic', 'Blackberries', 'Pickling Spice', 'Small amberjack', 'Cottage Cheese', 'Celery', 'Figs', 'Cassia Bark', 'Squid', 'Blue Eye Trevalla', 'Squash', 'Prunes', 'Juniper Berries', 'Whitespotted conger', 'Walnut', 'Celery', 'Bush Tomato', 'Tarragon', 'Eel', 'Sesame Oil', 'Onion', 'Pineapple', 'Allspice Whole', 'Japanese whiting', 'White Bread', 'Okra', 'Pomegranate', 'Pepper Black Ground', 'Alaskan pink shrimp', 'Tarragon', 'Butternut lettuce', 'Sultanas', 'Mustard Seed Black', 'Mirugai clam', 'Tempeh', 'Onion', 'Elderberry', 'Celery Salt', 'Eggs', 'Flaxseed Oil', 'Peas', 'Longan', 'Thai Red Curry Mix', 'Scallop', 'Asparagus', 'Asparagus', 'Dragonfruit', 'Zahtar Spice Mix', 'Trough shells', 'Haricot Beans', 'Purple carrot', 'Kiwi Fruit', 'Curry Thai Green', 'Sprite', 'Macadamia Oil', 'Raspberry', 'Loquats', 'Ras-el-Hanout', 'Trout', 'Rice Paper', 'Jerusalem Artichoke', 'Pineapple', 'Creole Seasoning', 'Small amberjack', 'Green Tea', 'Broccoli', 'Peaches', 'Bay Leaves', 'Abalone', 'Vermicelli Noodles', 'Cauliflower', 'Blackberries', 'Lemon Pepper', 'Scallop', 'Red Pepper', 'Artichoke', 'Cantaloupe', 'Korma Curry Powder', 'Halfbeak', 'Anchovies', 'Kohlrabi', 'Nectarines', 'Mustard Powder', 'Firefly squid', 'Pork', 'Spinach', 'Bush Tomato', 'Curry Madras Medium', 'Crab', 'Oats', 'Cucumber', 'Butter', 'Chilli Crushed', 'Milt', 'Juniper Berries', 'French eschallots', 'Cherries', 'Peppercorns Szechwan', 'Japanese style-chunky omelette', 'Porcini Mushrooms', 'Red Pepper', 'Custard Apples Daikon', 'Nigella', 'Whitespotted conger', 'Curry Powder', 'Beans', 'Loquats', 'Ajwan Seed', 'Greater amberjack', 'Curry Powder', 'Fresh Chillies', 'Cranberry', 'Mulled Cider Spices', 'Whitespotted conger');
v_item varchar2(255);
...
LOOP
   ...
   v_gasit := v_gasit+1;
      ...
      v_ok := true;
      myArray.extend();
      myArray(myArray.count):= v_random ;
      end if;
END LOOP;
